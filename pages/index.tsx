...
const Home: NextPage = () => {
  return (
    <div>
      <Head>
        <title>SFD Codes</title>
        <meta
          name="description"
          content="A place to learn about codes for Stem from Dance"
        />
      </Head>
      <main className="leading-normal tracking-normal text-white gradient">
        <div className="pt-24">
          <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
              ...
              <div className="relative z-10 flex space-x-2  flex-wrap justify-center w-full my-6">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://editor.p5js.org/ejfranco06/sketches/l--nc2lxq"
                  className=" w-52 my-2 bg-white text-gray-800 font-bold rounded-full  py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                >
                  Starter Template
                </a>
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.stemfromdance.org/"
                  className="w-52 my-2 bg-white text-gray-800 font-bold rounded-full  py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                >
                  Stem From Dance
                </a>
            ...
            <div className="w-full md:w-3/5 py-6 text-center pl-8">
        ...
        <section className="bg-white border-b py-8">
          <div className="container mx-auto flex flex-wrap pt-4 pb-12 justify-center items-start">
            ...
            <div className="w-full md:w-1/4 mx-6 my-4 justify-center items-center bg-white shadow-xl rounded-lg flex flex-col text-black">
              <img
                src="/solo-dance-stick.png"
                alt="img"
                title="img"
                width="200"
                height="200"
              ...
              <div className="w-full p-4  justify-start flex flex-col">
                <h4 className="border-b-2 text-3xl">Dancing Stick Figure</h4>
                <a
                  href="https://editor.p5js.org/tonio.bevacqui/sketches/R4lM5a2LB"
                  target="_blank"
                  rel="noreferrer"
                  className="mx-auto text-center lg:mx-0 gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                >
                  See Demo
                </a>
              </div>
            ...
            <div className="w-full md:w-1/4 mx-6 my-4 justify-center items-center bg-white shadow-xl rounded-lg flex flex-col text-black">
              ...
              />
              <div className="w-full p-4  justify-start flex flex-col">
                <h4 className="border-b-2 text-3xl">Bumble Bee Flight</h4>
                <a
                  href="https://editor.p5js.org/aatish/sketches/Hkckh3_Lz"
                  target="_blank"
                  rel="noreferrer"
                  className="mx-auto text-center lg:mx-0 gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                >
            ...
            <div className="w-full md:w-1/4 mx-6 my-4 justify-center items-center bg-white shadow-xl rounded-lg flex flex-col text-black">
              ...
              <div className="w-full p-4  justify-start flex flex-col">
                ...
                <a
                  href="https://editor.p5js.org/ejfranco06/sketches/s-JPbG4p-"
                  target="_blank"
                  rel="noreferrer"
                  className="mx-auto text-center lg:mx-0 gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                >
            ...
            <div className="w-full md:w-1/4 mx-6 my-4 justify-center items-center bg-white shadow-xl rounded-lg flex flex-col text-black">
              ...
              />
              <div className="w-full p-4  justify-start flex flex-col">
                <h4 className="border-b-2 text-3xl">Dancing Girl</h4>
                <a
                  href="https://editor.p5js.org/ejfranco06/sketches/kjQvJu0V0"
                  target="_blank"
                  rel="noreferrer"
                  className="mx-auto text-center lg:mx-0 gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                >
            ...
            <div className="w-full md:w-1/4 mx-6 my-4 justify-center items-center bg-white shadow-xl rounded-lg flex flex-col text-black">
              ...
              />
              <div className="w-full p-4  justify-start flex flex-col">
                <h4 className="border-b-2 text-3xl">Dance Party</h4>
                <a
                  href="https://editor.p5js.org/lf1700/sketches/uW9aR-oxJ"
                  target="_blank"
                  rel="noreferrer"
                  className="mx-auto text-center lg:mx-0 gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                >
        ...
        <section className="container mx-auto text-center py-6 px-4">
          ...
          <h3 className="my-4 text-3xl leading-tight ">
            You can start by reading the documentation to learn new functions!
          </h3>
          <a
            target="_blank"
            rel="noreferrer"
            href="https://p5js.org/reference/"
            className="block max-w-max mx-auto hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
          >
            Read Docs
          </a>
        </section>
